...
%start main_block 
%error-verbose
%token declaration identifier unary operator number assignmentop comparisionop logicalop while_x for_x if_x main_x printf_x return_x new_line
%left '+' '-'
%left '/' '*'
%left '%'
...
main_block : declaration main_x '(' ')'  multiple_expressions
	;
...
//		    | expression ';' multiple_expressions
		    | multiple_expressions multiple_expressions	
          	| body 
     ;
