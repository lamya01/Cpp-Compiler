...
%token MAIN
%token INT FLOAT CHAR DOUBLE LONG UNARYPLUS UNARYMINUS
...
STATEMENT:DECLARATIVE ';'|CONDITIONAL|WHILELOOP|FORLOOP|ASSIGNMENT ';' |ASSIGNMENT { printf("\n Missing Selmicolon at line%d",line_num); errno++;}
...
UNARY: VARIABLE UNARYPLUS {if(strcmp(prev,curr)!=0) {int i;
                                           i=search_symbol($1);
                                           if(i==-1) {
                                            printf("\n Undefined Variable at Line %d \n",line_num+1);
                                            errno++; 
     ...
     | VARIABLE UNARYMINUS {if(strcmp(prev,curr)!=0) {int i;
                                           i=search_symbol($1);
                                           if(i==-1) {
                                            printf("\n Undefined Variable at Line %d \n",line_num+1);
                                            errno++; 
